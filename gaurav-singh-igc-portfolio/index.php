...
<head>
    <title>Portfolio @ <?php echo APP['APP_NAME']; ?></title>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=yes" />
    <?php include $RunningDir . "/assets/HeaderStylesheets.php"; ?>
    <meta name="title" content="Portfolio of Gaurav Singh (gauravsinghigc) - Full Stack Developer & IT Solutions Expert">
    <meta name="description" content="Explore the portfolio of Gaurav Singh (gauravsinghigc) from Faridabad, a full stack developer specializing in custom web solutions, mobile app development, CRM systems, digital marketing, and IT support.">
    <meta name="keywords" content="Gaurav Singh, gauravsinghigc, portfolio, full stack developer, IT support, web development, CRM solutions, PHP developer, JavaScript developer, Node.js, React.js, Angular.js, Vue.js, mobile app development, digital marketing, custom software development, Faridabad, IT solutions, technical services, project showcase, cross-platform apps">
</head>
    ...
    <main class="main-page-wrapper">
        ...
        <div class="container" style="margin-top: 14rem;">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title text-left">
                        <h2 class="title mb-4">Portfolio, Work Experience <br> <?php echo APP['APP_NAME']; ?></h2>
                        <span class="subtitle">completed work, experience and delivered things</span>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12 mt-5 mb-5 pb-3">
                    <p>Hello, I’m <strong>Gaurav Singh</strong>, widely recognized online as <strong>gauravsinghigc</strong>. Based in <strong>Faridabad</strong>, I’ve been actively working in the <strong>IT industry since 2019</strong>, delivering impactful solutions to clients across the <strong>Delhi-NCR</strong> region. As a <strong>full-stack developer</strong>, <strong>CRM expert</strong>, and <strong>IT support specialist</strong>, I have successfully completed numerous projects that drive growth and efficiency for businesses. My portfolio showcases diverse projects that highlight my expertise, creativity, and commitment to quality.</p>

                    <h4>Portfolio Highlights</h4>
                    <p class="text-justify">Here’s a glimpse into some of my notable projects:</p>
                    <ul>
                        <li><strong>Custom Web Solutions</strong>: Designed and developed scalable websites for businesses in industries such as e-commerce, real estate, and education, ensuring responsive and user-friendly designs.</li>
                        <li><strong>Advanced Authentication Systems</strong>: Implemented secure login and data protection features for enterprise-level applications, enhancing security and user experience.</li>
                        <li><strong>Cross-Platform Mobile Apps</strong>: Delivered intuitive mobile applications for Android and iOS, including apps for logistics, health tracking, and customer engagement.</li>
                        <li><strong>CRM Development</strong>: Built customized CRM solutions for lead management, automated workflows, and improved customer interaction, streamlining business operations.</li>
                        <li><strong>SEO and Digital Marketing Projects</strong>: Boosted online visibility for brands by creating data-driven strategies, achieving higher rankings on search engines and improved ROI.</li>
                    </ul>

                    <h4>My Expertise</h4>
                    <p class="text-justify">With years of experience in technology and development, I specialize in:</p>
                    <ul>
                        <li>Building secure, scalable, and high-performance <strong>web applications</strong></li>
                        <li>Developing <strong>cross-platform mobile applications</strong> for diverse industries</li>
                        <li>Creating innovative <strong>CRM systems</strong> tailored to business needs</li>
                        <li>Implementing effective <strong>digital marketing</strong> strategies for brand growth</li>
                        <li>Providing <strong>IT support</strong> and maintaining system performance</li>
                    </ul>

                    <h4>Why Choose Gaurav Singh (gauravsinghigc)?</h4>
                    <p class="text-justify">My portfolio reflects a strong track record of delivering high-quality IT solutions tailored to diverse business needs. Based in <strong>Faridabad</strong>, I understand the unique challenges of the <strong>Delhi-NCR</strong> market and consistently deliver solutions that produce measurable results. I stay ahead of industry trends, ensuring my clients benefit from the latest technologies and practices.</p>

                    <h4>Let’s Bring Your Vision to Life</h4>
                    <p class="text-justify">Explore my portfolio to see how I’ve helped businesses achieve their goals. Whether you’re looking for <strong>web development</strong>, <strong>CRM solutions</strong>, or <strong>digital marketing expertise</strong>, I’m here to turn your ideas into reality. Reach out today, and let’s create something extraordinary together!</p>
                </div>
        ...
        <div class="container mt-5">
            ...
            <div class="row row--25 mt--10 mt_md--10 mt_sm--10">
                <?php include $RunningDir . "/includes/sections/PortFolioList.php"; ?>
            </div>
        </div>
        <div class="container mt-5">
            <div class="row mt-4">
