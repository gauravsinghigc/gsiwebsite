        ...
        <div class="container gsi-blog-area bg-gradient">
            <div class="row">
                ...
                <div class="col-md-12 text-center">
                    <hr>
                    <a onclick="HidePopUpForm()" style="position: fixed;top: 5rem;right: 5rem;color: #f60000;font-size: 2rem !important;" class="gsi-btn btn-sm fs-6"><i class="fa fa-times"></i></a>
                </div>
            </div>
        </div>
    </div>
